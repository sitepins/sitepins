...
See the [root README](../README.md) for the project overview, self-hosting quickstart, and Docker. Media storage setup is documented in [api/README.md](../api/README.md#media-storage-s3-compatible).
