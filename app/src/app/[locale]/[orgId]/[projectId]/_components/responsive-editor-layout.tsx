        ...
        >
          <TabsList className="border-border mb-4 flex h-8 w-full gap-x-2 overflow-hidden rounded-md border sm:h-9">
            <TabsTrigger value="frontmatter" asChild>
              <Button
                className="data-active:bg-primary! data-active:text-primary-foreground! bg-secondary text-secondary-foreground hover:bg-secondary/80 hover:text-foreground h-full flex-1 rounded-sm border-none shadow-none data-active:shadow-sm"
                size="sm"
              >
