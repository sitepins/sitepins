...
export default function ArrangementItem({
  ...
  return (
    <Reorder.Item
      className="border-b-border! bg-background flex cursor-grab items-center border-b px-2 py-2 last:border-b-0"
      value={arrangement}
      id={arrangement.id}
      style={{ y, boxShadow }}
      dragListener={false}
    ...
    >
      ...
      <div className="flex min-w-0 flex-1 items-center justify-between select-none">
        <div className="me-2 flex min-w-0 items-center">
          <Icon className="me-2 size-6 shrink-0" />
