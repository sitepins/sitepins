...
function DropdownMenuCheckboxItem({
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      data-inset={inset}
      className={cn(
        "data-highlighted:bg-light data-highlighted:text-text data-highlighted:**:text-text relative flex cursor-pointer items-center gap-2 rounded-md py-1.5 ps-1.5 pe-8 text-sm outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 data-inset:ps-7 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      checked={checked}
      {...props}
...
function DropdownMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "text-muted-foreground group-data-highlighted/dropdown-menu-item:text-text ms-auto text-xs tracking-widest",
        className,
      )}
      {...props}
    />
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubmenuTrigger
      ...
      data-inset={inset}
      className={cn(
        "data-highlighted:bg-light data-highlighted:text-text data-popup-open:bg-light data-popup-open:text-text not-data-[variant=destructive]:data-highlighted:**:text-text flex cursor-pointer items-center gap-2 rounded-md px-1.5 py-1.5 text-sm outline-hidden select-none data-inset:ps-7 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    >
