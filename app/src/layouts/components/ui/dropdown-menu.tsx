...
function DropdownMenuCheckboxItem({
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      data-inset={inset}
      className={cn(
        "data-highlighted:bg-light data-highlighted:text-text-default data-highlighted:**:text-text-default relative flex cursor-pointer items-center gap-2 rounded-md py-1.5 ps-1.5 pe-8 text-sm outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 data-inset:ps-7 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      checked={checked}
      {...props}
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.GroupLabel
      ...
      data-inset={inset}
      className={cn(
        "text-muted-foreground px-1.5 py-1.5 text-xs font-medium data-inset:ps-7",
        className,
      )}
      {...props}
    />
...
function DropdownMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "text-muted-foreground group-data-highlighted/dropdown-menu-item:text-text-default ms-auto text-xs tracking-widest",
        className,
      )}
      {...props}
    />
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubmenuTrigger
      ...
      data-inset={inset}
      className={cn(
        "data-highlighted:bg-light data-highlighted:text-text-default data-popup-open:bg-light data-popup-open:text-text-default not-data-[variant=destructive]:data-highlighted:**:text-text-default flex cursor-pointer items-center gap-2 rounded-md px-1.5 py-1.5 text-sm outline-hidden select-none data-inset:ps-7 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    >
    ...
    <DropdownMenuPrimitive.Portal>
      ...
      >
        <DropdownMenuPrimitive.Popup
          ...
          className={cn(
            "data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 data-closed:zoom-out-95 data-open:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 ring-foreground/10 bg-popover text-popover-foreground z-150 min-w-24 origin-(--transform-origin) overflow-hidden rounded-md p-1 shadow-lg ring-1 duration-100",
            className,
          )}
          {...props}
        />
