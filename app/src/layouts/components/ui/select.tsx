...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "border-border data-placeholder:text-muted-foreground hover:bg-input/50 aria-invalid:border-destructive flex w-full items-center justify-between gap-1.5 rounded-lg border py-2 ps-2.5 pe-2 text-sm whitespace-nowrap transition-colors outline-none select-none disabled:cursor-not-allowed disabled:opacity-50 data-disabled:cursor-not-allowed data-disabled:opacity-50 data-[size=default]:h-9 data-[size=sm]:h-7 data-[size=sm]:rounded-[min(var(--radius-md),10px)] *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-1.5 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    >
    ...
    <SelectPrimitive.Portal>
      ...
      >
        <SelectPrimitive.Popup
          ...
          className={cn(
            "bg-background text-text-default data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 data-closed:zoom-out-95 data-open:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 ring-foreground/10 relative z-150 max-h-(--available-height) w-(--anchor-width) min-w-36 origin-(--transform-origin) overflow-hidden rounded-lg shadow-md ring-1 duration-100 data-[align-trigger=true]:animate-none",
            position === "popper" &&
        ...
        >
          ...
          <SelectPrimitive.List
            ...
            className={cn(
              "max-h-(--available-height) scroll-py-6 overflow-x-hidden overflow-y-auto p-1 data-[position=popper]:w-full data-[position=popper]:min-w-(--anchor-width)",
            )}
          >
            {children}
          </SelectPrimitive.List>
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "data-highlighted:bg-light data-highlighted:text-text-default not-data-[variant=destructive]:data-highlighted:**:text-text-default relative flex w-full cursor-pointer items-center gap-1.5 rounded-md py-1 ps-1.5 pe-8 text-sm outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
        className,
      )}
      {...props}
    >
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpArrow
      ...
      className={cn(
        "bg-background/95 text-muted-foreground hover:text-foreground inset-x-0 top-0 z-10 flex h-6 w-full cursor-default items-center justify-center rounded-t-lg py-1 backdrop-blur-xs [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    >
...
function SelectScrollDownButton({
  ...
  return (
    <SelectPrimitive.ScrollDownArrow
      ...
      className={cn(
        "bg-background/95 text-muted-foreground hover:text-foreground inset-x-0 bottom-0 z-10 flex h-6 w-full cursor-default items-center justify-center rounded-b-lg py-1 backdrop-blur-xs [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    >
